...
videos_to_process = sorted(os.listdir(video_source))

# Skip 27 because its already done.
videos_to_process = videos_to_process[:27] + videos_to_process[28:]

video_result = '/Users/rohuntripathi/Course_3D_Reconstruction/datasets/Split_Museum_1_second_segments_DfUSMC_result_longer_convergence'
